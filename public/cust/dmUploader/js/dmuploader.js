...
(function($) {
  ...
  DmUploader.prototype.queueFiles = function(files)
  {
    ...
    if( window.shouldUpdate || window.shouldUpdate != 'undefined' || window.shouldUpdate != null ){
    ...
    for (var i= 0; i < files.length; i++)
    {
      ...
      if( window.shouldUpdate || window.shouldUpdate != 'undefined' || window.shouldUpdate != null ){
        ...
        var theBiggestId = 0;
          ...
          var newIndex = ++theBiggestId;

          this.settings.onNewFile.call(this.element, newIndex, file);
    ...
    fd.append(widget.settings.fileName, file);
      ...
      if( window.shouldUpdate || window.shouldUpdate != 'undefined' || window.shouldUpdate != null ){
        ...
        var theBiggestId = 0;
          ...
          var can_continue = widget.settings.onBeforeUpload.call(widget.element, newIndex );
              ...
              percent = Math.ceil(position / total * 100);
                  ...
                  if( window.shouldUpdate || window.shouldUpdate != 'undefined' || window.shouldUpdate != null ){
                    ...
                    var theBiggestId = 0;
                      ...
                      widget.settings.onUploadProgress.call(widget.element, newIndex , percent);
      ...
      success: function (data, message, xhr){
        ...
        if( window.shouldUpdate || window.shouldUpdate != 'undefined' || window.shouldUpdate != null ){
                    ...
                    var theBiggestId = 0;
                      ...
                      widget.settings.onUploadSuccess.call(widget.element, newIndex, data);
      ...
      error: function (xhr, status, errMsg){
        ...
        if( window.shouldUpdate || window.shouldUpdate != 'undefined' || window.shouldUpdate != null ){
                    ...
                    var theBiggestId = 0;
                      ...
                      widget.settings.onUploadError.call(widget.element, newIndex, errMsg);
