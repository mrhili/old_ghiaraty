(function( $, window, undefined ) {
  $.danidemo = $.extend( {}, {
    ...
    addFile: function(id, i, file, ifDelete){

    	ifDelete = ifDelete || false;
    	if( ifDelete ){

    		deleteItem = '<div class="">'+
		                       '<a id="deleteItem" class="btn btn-small btn-danger text-center" data-item-number="'+ i +'" href="" > مسح الصورة </a>'+
		                  '</div>';
	...
	addLink: function(id, i, link){


		var template = '<div id="demo-file' + i + '">' +
		                   '<img src='+link+' class="demo-image-preview" />' +
		                   '<span class="demo-file-id">#' + i + '</span>'+
		                   '<div class="">'+
		                       '<a id="deleteItem" class="btn btn-small btn-danger text-center" data-item-number="'+ i +'" href="" > مسح الصورة </a>'+
		                  '</div>' +
		                  '<br />'+
