                     ...
                     <div class="col-lg-12">
                           ...
                           <div class="row">
                              <div class="col-xs-12 social-btns">
                                 <div class="col-xs-3 col-md-1 col-lg-1 social-btn-holder">
                                    <a href="#" class="btn btn-social btn-block btn-google" rel="nofollow">
                                    <i class="fa fa-google"></i> </a>
                                 </div>
                                 <div class="col-xs-3 col-md-1 col-lg-1 social-btn-holder">
                                    <a href="#" class="btn btn-social btn-block btn-facebook" rel="nofollow">
                                    <i class="fa fa-facebook"></i> </a>
                                 </div>
                                 <div class="col-xs-3 col-md-1 col-lg-1 social-btn-holder">
                                    <a href="#" class="btn btn-social btn-block btn-twitter" rel="nofollow">
                                    <i class="fa fa-twitter"></i> </a>
                                 </div>
                                 <div class="col-xs-3 col-md-1 col-lg-1 social-btn-holder">
                                    <a href="#" class="btn btn-social btn-block btn-linkedin" rel="nofollow">
                                    <i class="fa fa-linkedin"></i> </a>
                                 </div>
                                 <div class="col-xs-3 col-md-1 col-lg-1 social-btn-holder">
                                    <a href="#" class="btn btn-social btn-block btn-github" rel="nofollow">
                                    <i class="fa fa-github"></i> </a>
                                 </div>
                                 <div class="col-xs-3 col-md-1 col-lg-1 social-btn-holder">
                                    <a href="#" class="btn btn-social btn-block btn-stackoverflow" rel="nofollow">
                        ...
                        <div class="col-xs-12 col-sm-8">
                           <ul class="list-group">
                              ...
                              <li class="list-group-item"><i class="fa fa-at"></i> {{ $userInstance->email }}</li>
                              <li class="list-group-item"><i class="fa fa-phone"></i> {{ $userInstance->tel }}</li>
                              <li class="list-group-item"><i class="fa fa-clock-o"></i> {{  $userInstance->created_at  }}</li>

                              @if( $userInstance->admin == 1 )

                              <li class="list-group-item"><i class="fa fa-vcard-o"></i> أدمين</li>
