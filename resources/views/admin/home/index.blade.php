    ...
    <section class="content">
      ...
      <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="{{ route('admin-users-panel.index') }}" class="small-box-footer"><i class="fa fa-arrow-circle-right"></i> الجميع</a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="{{ route('pieces.index') }}" class="small-box-footer"> الجميع <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
